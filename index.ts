  ...
  return class StereoSound extends Plugin {
    onStart() {
      ...
      thisObj.conn.setTransportOptions = function (obj) {
        ...
        if (obj.encodingVoiceBitRate < 1280000 ) { //128
